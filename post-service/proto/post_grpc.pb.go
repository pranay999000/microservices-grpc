...
const (
	...
	PostService_Posts_FullMethodName      = "/post.PostService/Posts"
)
...
type PostServiceClient interface {
	...
	Posts(ctx context.Context, in *GetAllPostsRequest, opts ...grpc.CallOption) (*GetAllPostsResponse, error)
}
...
func (c *postServiceClient) Posts(ctx context.Context, in *GetAllPostsRequest, opts ...grpc.CallOption) (*GetAllPostsResponse, error) {
	out := new(GetAllPostsResponse)
	err := c.cc.Invoke(ctx, PostService_Posts_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PostServiceServer interface {
	...
	Posts(context.Context, *GetAllPostsRequest) (*GetAllPostsResponse, error)
...
func (UnimplementedPostServiceServer) Posts(context.Context, *GetAllPostsRequest) (*GetAllPostsResponse, error) {
...
func _PostService_Posts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PostService_Posts_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PostServiceServer).Posts(ctx, req.(*GetAllPostsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
